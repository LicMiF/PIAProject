<?php
    ...
    if(!$metaData)
    {
        if($user->insertDataGeneric(array('commentId','senderId','liked'),array($commentId,$senderId,1),'likes'))
            echo "Success!";
        else 
            echo "Failed!";
    }
        ...
        else
        {
            ...
            if($user->updateDataGeneric('likes',array('liked'),array(1),array('commentId','senderId'),array($commentId,$senderId)))
                echo "Success!";
            else 
                echo "Failed!";
        }
